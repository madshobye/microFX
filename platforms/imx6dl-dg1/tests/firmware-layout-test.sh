...
PROJECT_UPDATER="$ROOT/scripts/project-upload.sh"
PROJECT_BUNDLE_UPDATER="$ROOT/scripts/bundled-projects-upload.sh"
PROJECT_TARGET="$ROOT/scripts/lib/project-update-target.sh"
STUDIO_UPDATER="$ROOT/scripts/studio-upload.sh"
STUDIO_TARGET="$ROOT/scripts/lib/studio-update-target.sh"
...
test -x "$PROJECT_UPDATER"
test -x "$PROJECT_BUNDLE_UPDATER"
